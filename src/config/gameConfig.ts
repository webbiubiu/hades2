...
export const gameConfig = {
  // 站点配置
  site: {
    title: "Hades 2 News & Guides",
    description: "Your ultimate source for Hades 2 news, guides, and reviews",
    domain: "hades2.org",
  ...
  game: {
    ...
    introduction: {
      ...
      content: "Supergiant Games has officially launched Hades 2, the highly anticipated rogue-like dungeon crawler and long-awaited sequel to the award-winning Hades. Hades 2 v1.0 launches worldwide on September 25, 2025, bringing the full mythic adventure to Nintendo Switch, Switch 2, Steam, and Epic Games Store. Building on the strengths of the original, Hades 2 introduces an expanded, dynamic world of Greek mythology, featuring the immortal Princess of the Underworld, Melinoë, as the lead protagonist. Players will tackle the sinister Titan of Time, explore new areas, encounter new characters, and unlock dozens of story events, voice lines, and achievements. The 1.0 release adds the final chapter of the story as well as new end-game activities and challenges after facing the game's multiple final bosses. Key features of this launch include cross-save support between PC and Switch family platforms, allowing seamless progress transfer. Hades 2 on Switch 2 supports blazing-fast 120fps performance at 1080p in TV mode, while the original Switch maintains 60fps at 720p. Early Access players receive a free automatic upgrade to version 1.0, and a physical edition for Switch 2 is set for release later this year, featuring a character compendium, soundtrack download, and unique bonus content. Hades 2 is already recognized as one of the highest-rated games of 2025, praised for its evolved rogue-like progression, engaging combat loop, rich narrative, and best-in-class writing and voice performances. Supergiant Games extends thanks to its global community for their feedback and support throughout development.",
      highlights: [
  ...
  sampleContent: {
    blogPosts: [
      {
        title: "Hades 2 v1.0 Launch: Everything You Need to Know",
        excerpt: "The full release of Hades 2 is finally here! Discover all the new content, features, and improvements in this comprehensive launch guide.",
      ...
      {
        title: "All New Weapons and Combat Changes in Hades 2",
      ...
      },
      {
        ...
        excerpt: "Hades 2 officially exits early access and immediately breaks its predecessor's Steam concurrent player records, drawing over 60,000 players within the first hour.",
    ...
    videos: [
      {
        ...
        description: "The third Major Update for Hades 2 is finally here, focused on expanding core combat, Guardian encounters, and character relationships, with lots of new visual flair!",
        embedId: "2Gv0eQjJ-gY"
      },
      {
        title: "The Warsong Update Trailer",
        description: "The second Major Update for Hades 2 has arrived, featuring all-new encounters at the end of the surface route, the arrival of violence-loving Ares, updates to Arcana and resource collection, and much more!",
        embedId: "yrpGYTlCjNQ"
      },
      {
        title: "The Olympic Update Trailer",
        description: "The first Major Update for Hades 2 is finally here, featuring spectacular new places to explore, colorful new characters to meet, a wild new weapon to master, and much, much more! Take a peek:",
        embedId: "WH3jT53hIYM"
      }
    ]
  }
